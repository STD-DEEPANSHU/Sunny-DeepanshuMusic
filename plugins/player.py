...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: Sunny & Deepanshu Player (@Sunny_meena @STD_DEEPANSHU)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
@Client.on_message(
    commandpro(["/play", ".play", "deepanshu", "sunny", "!play", "play", "@", "#", "$"])
    & filters.group
    & ~filters.edited
    & ~filters.forwarded
    & ~filters.via_bot
...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "Deepanshu_Player"
    usar = user
    wew = usar.id
    try:
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "** 😎 𝐈🤞𝐚𝐦 🥀 𝐑𝐞𝐚𝐝𝐲 ♥️ 𝐓𝐨 ⭐ 𝐏𝐥𝐚𝐲 😎 ... 𝐔𝐬𝐞 📢 /play, .play, deepanshu, sunny, !play, play, @, #, $ **")
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/7e21fadaa6d92c195b481.jpg"
        ...
        keyboard = InlineKeyboardMarkup(
            [
               ...
               [
                        InlineKeyboardButton(
                            text="😎 𝐒𝐓𝐃 🌺",
                            url=f"https://t.me/best_friends_chat_group")
        ...
        try:
            ...
            [
               ...
               [
                        InlineKeyboardButton(
                            text="😎 𝐒𝐓𝐃 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 🌺",
                            url=f"https://t.me/DEEPANSHU_WORLD")
            ...
            [
               ...
               [
                        InlineKeyboardButton(
                            text="😎 𝐅𝐞𝐞𝐋𝐢𝐧𝐠'𝐒 🌺",
                            url=f"https://t.me/girls_and_boys_dp")
...
@Client.on_message(commandpro(["skip", ".skip", "sd", "/skip", "!skip"]) & other_filters)
@errors
@authorized_users_only
...
@Client.on_message(commandpro(["end", "/end", "!end", ".end", "stop", "/stop", "std", ".stop", "stop", "x"]) & other_filters)
@errors
@authorized_users_only
