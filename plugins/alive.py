...
┣❥︎ 𝐂𝐫𝐞𝐚𝐭𝐨𝐫 ➪ » [𝐒𝐮𝐧𝐧𝐲](https://t.me/Sunny_meena)
┣❥︎ 𝐂𝐫𝐞𝐚𝐭𝐨𝐫2 ➪ » [𝐃𝐞𝐞𝐩𝐚𝐧𝐬𝐡𝐮](https://t.me/STD_DEEPANSHU)
┗━━━━━━━━━━━━━━━━━┛
...
@Client.on_message(commandpro(["/start", f"start@{BOT_USERNAME}", "/alive", ".alive", "#sunny", "#deepanshu"]) & filters.group & ~filters.edited)
...
@Client.on_message(commandpro(["repo", "#repo", "@repo", "/repo", "deepanshu", "sunny", "source"]) & filters.group & ~filters.edited)
async def help(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/7e21fadaa6d92c195b481.jpg",
        caption=f"""""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
